        ...
        if (array === 1) {
          return (
            <motion.svg
              className="disk"
              animate={{
                top: ["0%", gridPositionRow[rowIndex] + "%"],
    ...
    return winnerPos.map((pos, index) => {
      return (
        <svg
          ...
          style={{
            left: gridPositionColumn[pos[1]] + 2.22 + "%",
            top: gridPositionRow[pos[0]] + 3 + "%",
          }}
        >
